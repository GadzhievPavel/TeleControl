...
public class Custom2Joystick extends View
        implements
        Runnable {
    ...
    */
    ...
    public interface OnMoveListener {
         ...
         * @param topic name of topic ROS
         */
        void onMove(int angle, int strength, String name, String topic);
    }
    ...
    */
     ...
     */
    public Custom2Joystick(Context context) {
        this(context, null);
    }


    public Custom2Joystick(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }
     ...
     */
    public Custom2Joystick(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        setTextSizeForWidth(mPaintText,50,getName());
        canvas.drawText(getName(),20,30, mPaintText);
        // Draw the background
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (mAutoReCenterButton) {
                ...
                if (mCallback != null)
                    mCallback.onMove(getAngle(), getStrength(),getName(),getTopic());
            }
